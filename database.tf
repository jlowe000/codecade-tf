...
resource oci_database_autonomous_database export_codecard {
...
resource oci_database_autonomous_database_wallet export_codecard_wallet {
    #Required
    autonomous_database_id = oci_database_autonomous_database.export_codecard.id
    password = var.custom_adb_admin_password
    base64_encode_content  = "true"
    generate_type = "SINGLE"
}
resource local_file export_codecard_wallet_file {
    content_base64 = oci_database_autonomous_database_wallet.export_codecard_wallet.content
    filename = "${path.module}/codecard-wallet.zip"
}
